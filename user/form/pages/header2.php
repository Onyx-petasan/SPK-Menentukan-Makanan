...
session_start();
 ...
 $sql = mysql_query("SELECT * FROM tb_pengguna tp, tb_user tu WHERE tp.`password` = tu.`password` AND id = '$userlogin'") or die(mysql_error());
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">  
          <a href="home2.php?page=home">SPK Pemilihan Makanan</a>
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        <ul class="navbar-nav mr-lg-4 w-100">
          <li class="nav-item">
            <a class="nav-link" href="home2.php?page=home">
              <h4>Home</h4>
            </a>
          </li>
        </ul>
        <ul class="navbar-nav mr-lg-4 w-100">
          <li class="nav-item">
            <a class="nav-link" href="home2.php?page=konsultasi">
              <h4>Konsultasi</h4>
            </a>
          </li>
        </ul><ul class="navbar-nav mr-lg-4 w-100">
          <li class="nav-item">
            <a class="nav-link" href="home2.php?page=profile">
              <h4>Profile</h4>
            </a>
          </li>
        </ul>
        <ul class="navbar-nav mr-lg-4 w-100">
          <li class="nav-item">
            <a class="nav-link" href="home2.php?page=petunjuk">
              <h4>Petunjuk</h4>
            </a>
          </li>
        </ul>
